...
@NamedQueries({
        @NamedQuery(name = "GrantAccess.findById_AccountIdAndId_RoleId", query = "select g from GrantAccess g where g.id.accountId = :accountId and g.id.roleId = :roleId"),
        @NamedQuery(name = "GrantAccess.findAll", query = "select g from GrantAccess g"),
        @NamedQuery(name = "GrantAccess.deleteById_AccountIdAndId_RoleId", query = "delete from GrantAccess g where g.id.accountId = :accountId and g.id.roleId = :roleId")
})
